  ...
  return (
    <footer className="py-12 bg-weddingCream text-center">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <p className="font-serif text-2xl text-weddingGold-dark mb-2">John & Dowy</p>
        <p className="text-weddingText mb-1">Looking forward to celebrating with you!</p>
        <p className="text-sm text-weddingText/70">&copy; {currentYear} John & Dowy. All rights reserved.</p>
      </div>
    </footer>
  )
}
